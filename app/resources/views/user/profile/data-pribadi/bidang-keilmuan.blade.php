...
@section('content')
    <div class="card p-3">
        <div class="d-flex justify-content-between">
            <h4 class="text-bold">Bidang Keilmuan Saya</h4>
        ...
        <p>Perubahan data ini tidak memerlukan validasi dan dapat langsung disimpan ke sistem</p>
        <table class="table table-bordered">
            <tr>
                <th class="border-0 pb-0">Pilih Kelompok Bidang</th>
                <th class="border-0 pb-0 text-center">Aksi</th>
            </tr>
            <tr>
                <td class="border-0">
