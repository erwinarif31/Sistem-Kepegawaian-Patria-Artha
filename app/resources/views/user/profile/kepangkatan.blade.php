...
@section('content')
    <div class="card p-3">
        <div class="d-flex justify-content-between">
            <h5 class="text-bold">Golongan/Pangkat</h5>
        ...
        <div>
            <a href="{{ route('user.kepangkatan.create') }}" class="btn btn-secondary btn-sm mt-auto mb-auto" style="font-size: 14px; fill: white">
            ...
            <table class="table mt-2 table-bordered" style="font-size: 14px">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('user.kepangkatan.detail') }}" class="btn btn-info" style="fill: white">
                        ...
                        <a href="{{ route('user.kepangkatan.edit') }}" class="btn btn-warning" style="fill: white">
